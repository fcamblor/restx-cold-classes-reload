...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("92f123da-21c6-4334-923c-866b5583c3db restx-cold-classes-reload restx-cold-classes-reload 222276810283555313".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in io.restx.sample package as a set of config entries
        return configLoader.fromResource("io/restx/sample/settings");
    }
